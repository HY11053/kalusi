...
class ListNewsController extends Controller
{
    ...
    public function listNews(Request $request,$path,$page=0)
    {
        ...
        if(Arctype::where('id',$typeid)->value('mid')==0)
        {
            ...
            return view('mobile.list_article',compact('thistypeinfo','pagelists','sontypes','productions','mendianlists'));
        }elseif (Arctype::where('id',$typeid)->value('mid')==1)
        {
            return view('mobile.index_lists',compact('thistypeinfo','pagelists','productions','mendianlists','sontypes'));
        }
    }
    ...
    public function shebeiList(Request $request,$page=0)
    {
        ...
        return view('mobile.shebei_list',compact('thistypeinfo','pagelists','sontypes','productions','mendianlists'));
