...
<div id="item5" class="clearfix">
    <div class="item5box">
        ...
        <mip-form method="post" target="_self" url="http://mip.czga.cn/phonecomplate">
        <div class="inputbox">
            {{csrf_field()}}
            <input type="hidden" name="host" value="{{str_replace('http://www.','http://mip.',config('app.url'))}}{{Request::getrequesturi()}}">
